                        ...
                        <div class="row mt-3 ">
                            ...
                            <div class="row me-2 ms-2 mt-3 ">
                                    <div class="col-12">
                                        ...
                                        $sql = "SELECT dangtin.noidung , dangtin.file, dangtin.time ,dangtin.ngongu, dangky.anh, dangky.taikhoan, dangtin.email FROM dangtin INNER JOIN dangky ON dangtin.email = dangky.email WHERE ngongu='C++' ORDER BY time DESC";
