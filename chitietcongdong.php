                ...
                <div class="col-md-9 col-lg-10 col-xl-10 " >
                        ...
                        <div class="row me-2 ms-2 mt-3 ">
                                <div class="col-12">
                                    ...
                                    $sql = "SELECT dangtin.noidung , dangtin.file, dangtin.time ,dangtin.ngongu, dangky.anh, dangky.taikhoan, dangtin.email FROM dangtin INNER JOIN dangky ON dangtin.email = dangky.email WHERE noidung = '".$_GET['noidung']."' ORDER BY time DESC";
