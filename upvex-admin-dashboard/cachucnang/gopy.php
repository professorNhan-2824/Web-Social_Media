                ...
                <div class="content">
                    ...
                    <!-- Start Content-->
                         ...
                         <?php 
                          ...
                          $sql = "SELECT *,  DATE_FORMAT(time, '%Y-%m-%d') as ngay, COUNT(*) as soluong  FROM `gopy` GROUP BY ngay ORDER BY ngay;";
                        ...
                        <div class="container-fluid" style="background-color: #595959;border-radius: 20px;">
