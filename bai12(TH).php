...
<head>
    ...
    <title>Tìm số phần tử trong một mảng C++</title>
    ...
    <div class="container-fluid">
        ...
        <section class="mt-5">
            <div class="row" style="clear: both;">
                ...
                <b style="font-size: 55px;">Tìm số phần tử trong một mảng C++</b>
                <div style="height: 20px;"></div>
                <hr>
                <div style="height: 20px;"></div>
                <p style="font-size: 25px;">
                    <strong>Viết chương trình tìm số phần tử trong một mảng C++, đây là một bài tập C++ khá đơn giản, các bạn hãy xem kỹ các ví dụ dưới đây để hiểu rõ hơn.</strong>
                </p>
                <div style="height: 20px;"></div>
                <div style="height: 20px;"></div>
                ...
                <div style="background-color: rgb(214, 209, 209);">
                    ...
                    <ul id="menu-bai1">
                        <li><a href="#div-bai1-1">Ví dụ: Tìm số phần tử trong một mảng C++</a></li>
                    </ul>
                </div>
                <div style="height: 50px;"></div>
                <!-- Phần 1 bài 1 -->
               <div>
                    <div id="div-bai1-1" style="background-color:  #0b7ae9;"><h1 style="color: white;padding:10px;">Ví dụ: Tìm số phần tử trong một mảng C++</h1></div>
                    <!-- <div style="height: 20px;"></div> -->
                    <div style="height: 20px;"></div>
                    <p style="font-size: 25px;">
                    ...
                    <div>
                        <div style="justify-content: center; display: flex;">
                            <textarea name="" id="" cols="70" rows="17" style="background-color: #222f3c; color: white; font-size: 20px;padding-left: 10px;padding-top: 15px;">
#include &lt;iostream&gt;
using namespace std;
int main()
{
...
//      các loại như int, char, float, v.v.
    ...
    cout&lt;&lt;"Chương trình này được đăng tại Freetuts.net";
                        ...
                        <div style="height: 20px;"></div>
                        <p style="font-size: 25px;"><strong>Kết quả:</strong> Khi chúng ta khai báo mảng arr[ ] = {11, 22, 33, 44, 55, 66} thì kết quả sẽ là 6.</p>
                        <div>
                            <img src="imageBai_12_TH/dem-so-phan-tu.jfif" alt="" class="w-100">
                        </div>
                        
                        <div style="height: 20px;"></div>
                        <p style="font-size: 25px;">Như vậy là chúng ta đã thực hiện xong chương trình C++ để đếm số phần tử trong mảng. Chúc các bạn thực hiện thành công!!!</p>
                    </div>
               </div>
                <div style="height: 20px;"></div>
                <hr>
                ...
                <div style="float: left;width: 100%;display: flex;">
                    <p id="bt" ><a href="bai11(TH).php">⇦ Bài trước </a></p>
                    <p id="bs"><a href="bai1(TH).php">Bài tiếp theo ⇨</a></p>
                </div>
               <div style="height: 50px;"></div>
                </div>
